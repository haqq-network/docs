...
Learn how to deploy a simple Solidity-based smart contract to Haqq using the Hardhat environment {synopsis}
...
module.exports = {
  ...
  networks: {
    ...
    testnet: {
      url: "https://haqq-archive-testnet.api.bdnodes.net:8545/",
      accounts: [privateKey1, privateKey2, ...]
    }
  },
  ...
