...
Learn how to deploy a simple Solidity-based smart contract to Haqq using the Remix in-browser IDE {synopsis}
...
![remix connected to haqq](../../../static/img/remix_deploy.png)
...
![deployed contract through remix](../../../static/img/remix_deployed.png)
...
![interacting with deployed contract through remix](../../../static/img/remix_interact.png)
