...
:::tip
**Note**: Further information about the process of setting up Keplr can be found in the official
...
**Add Account**, and select **Create New Account**
...
seed/mnemonic phrase, and press **Register**
...
- If you have used Keplr before, click on the silhouette in the upper-right corner, then the blue box labeled
**Add Account**, and select **Import Existing Account**
...
3. Make sure you are on the `Evmos Testnet` network from the dropdown. Testnet networks will likely be towards the bottom
of the list.
4. Update either the `RPC` or `Rest` or both inputs and click `Confirm`

## Connect Keplr to Mainnet

Once you are signed in to the Keplr extension, you can connect the wallet with the Evmos network. The Evmos mainnet network
is already built into Keplr and look for the `Evmos` network by clicking on the extension and scrolling to select the network.
