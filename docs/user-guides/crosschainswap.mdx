...
8. Set the recipient address on the HAQQ Network using Keplr or manually paste the Bech32 address.
   ...
   <div align="center">
     <img
       src="/img/user_guides/skip-destination.png"
       alt="skip-destination"
       width="500"
       height="250"
     >
       {' '}
...
<div align="center">
  <img
    src="/img/user_guides/skip-tx.png"
    alt="skip-tx"
    width="400"
    height="150"
  >
...
13. Next, you will see a screen indicating the EVM bridging finality time, which is approximately 16 minutes.
    ...
    <div align="center">
      <img
        src="/img/user_guides/skip-confirm.png"
        alt="skip-confirm"
        width="500"
        height="250"
      >
...
16. Once the transfer is complete, the successful status and transaction details will be shown.
    <div align="center">
      <img
        src="/img/user_guides/skip-final.png"
        alt="skip-final"
        width="1000"
        height="250"
      >
