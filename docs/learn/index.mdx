...
- Exposing a fully compatible Web3 [JSON-RPC](../api/json-rpc/server.md) layer for interacting with existing Ethereum clients and tooling ([Metamask](../user-guides/key-wallets/metamask.md), [Remix](../user-guides/tools/remix.md), [Truffle](../user-guides/tools/truffle.md), etc).
